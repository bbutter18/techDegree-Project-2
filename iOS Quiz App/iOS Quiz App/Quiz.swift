...
class Quiz {
    ...
    func firstQuestionSound() {
        var sound: SystemSoundID = 0
        sound = loadSound(sound: "round1", of: "wav")
        playSound(quizSound: sound)
    }
    
    func secondQuestionSound() {
        var sound: SystemSoundID = 0
        sound = loadSound(sound: "round2", of: "wav")
        playSound(quizSound: sound)
    }
    
    func thirdQuestionSound() {
        var sound: SystemSoundID = 0
        sound = loadSound(sound: "round3", of: "wav")
        playSound(quizSound: sound)
        
    }
    
    func fourthQuestionSound() {
        var sound: SystemSoundID = 0
        sound = loadSound(sound: "round4", of: "wav")
        playSound(quizSound: sound)
        
    }
    
    func fifthQuestionSound() {
        var sound: SystemSoundID = 0
        sound = loadSound(sound: "finalRound", of: "wav")
        playSound(quizSound: sound)
    ...
    func endOfQuizSound() {
        var sound: SystemSoundID = 0
        sound = loadSound(sound: "quizEnd", of: "Wav")
        playSound(quizSound: sound)
